...
<script>
	 ...
	 $().ready(function() {
		...
		$("[name='category']").val("${productDTO.category}");
...
<body>
	...
	<section class="checkout spad">
        <div class="container">
            <form action="${contextPath }/seller/product/sellerProductModify" method="post" enctype="multipart/form-data" class="checkout__form" >
                <div class="row">
                <input type="hidden" name="productCd" value="${productDTO.productCd }">
                    <div class="col-lg-8">
                        <h4>Product Revise</h4>
                        <br>
                        <div class="row  blog__details__option">
                            <div class="col-sm-12">
                                <div class="checkout__input">
                                    <p>상품이미지<span>*</span> <span class="icon_upload"></span> </p>
                                    <input type="file" name="productFileName" value="${productDTO.productFileName }">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="checkout__input">
                                    <p>상품명 <span>*</span></p>
                                    <input type="text" name="productNm" value="${productDTO.productNm }">
                                </div>
                            </div>
                            <div>
                            	<input type="hidden" name="sellerId" value="${productDTO.sellerId }"/>
                            </div>
                            <div class="col-sm-6">
                                <div class="checkout__input">
                                    <p>가격 <span>*</span></p>
                            ...
                            <div class="col-sm-6">
                                <div class="checkout__input">
                                    <p>할인률 <span>*</span></p>
                                    <input type="text" name="discountRate" value="${productDTO.discountRate }">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="checkout__input">
                            ...
                            <div class="col-sm-6">
                                <div class="checkout__input">
                                    <p>Brand <span>*</span></p>
                                    <input type="text" name="brand" value="${productDTO.brand }">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="checkout__input">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                               <div>
                                    ...
                                    남 &nbsp;<input type="radio" name="gender" value="m" <c:if test="${productDTO.gender eq 'm'}">checked</c:if>> &emsp;
                                    여 &nbsp;<input type="radio" name="gender" value="f" <c:if test="${productDTO.gender eq 'm'}">checked</c:if>>
                               </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                            	<div>
                            		<p>Size <span style="color:red;">*</span></p>
								        <label><input type="checkbox" id="sizeXsYn" name="sizeXsYn" value="Y" <c:if test="${productDTO.sizeXsYn eq 'Y'}">checked</c:if>> XS </label>&nbsp;    
                            ...
                            <div class="col-sm-12">
                                <div class="checkout__input">
                                    ...
                                    <textarea rows="5" cols="100" name="info"> ${productDTO.info }</textarea> 
            	...
            	<div align="right">
                	<button type="submit" class="site-btn"><span class="icon_plus"></span> Revise</button>
               	</div>
        	</form>
    	</div>
	</section>
